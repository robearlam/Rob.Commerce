...
namespace Plugin.Sample.Habitat
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(HabitatConstants.Pipelines.Blocks.InitializeCSCatalogBlock)]
    public class InitializeCSCatalogBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<string> Run(string arg, CommercePipelineExecutionContext context)
        {
            ...
            await _importCSCatalogCommand.Process(context.CommerceContext, "Habitat_Master.xml", "Habitat_Inventory.xml");
