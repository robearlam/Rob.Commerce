...
namespace Plugin.Sample.AdventureWorks
{
    ...
    ///     </cref>
    /// </seealso>
    [PipelineDisplayName(AwConstants.Pipelines.Blocks.InitializeCatalogBlock)]
    public class InitializeInventoryBlock : PipelineBlock<string, string, CommercePipelineExecutionContext>
    {
        ...
        public override async Task<string> Run(string arg, CommercePipelineExecutionContext context)
        {
            ...
            using (var stream = new FileStream(this.GetPath("AdventureWorks_Inventory.zip"), FileMode.Open, FileAccess.Read))
            {
