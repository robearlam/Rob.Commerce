...
{
    [PipelineDisplayName("Feature.Order.ServiceBus.PostmanSendOrdertoServiceBusBlock")]
    public class PostmanSendOrdertoServiceBusBlock : PipelineBlock<Order, string, CommercePipelineExecutionContext>
    {
        public string ConnectionString { get; private set; }
        public string Status { get; set; }

        public override async Task<string> Run(Order order, CommercePipelineExecutionContext context)
        {
