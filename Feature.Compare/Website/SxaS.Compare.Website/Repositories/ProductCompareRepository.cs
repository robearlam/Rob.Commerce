...
using SxaS.Compare.Website.Managers;
...
namespace SxaS.Compare.Website.Repositories
{
    public class ProductCompareRepository : BaseCatalogRepository, IProductCompareRepository
    {
        ...
        //        {
        //            var model = ModelProvider.GetModel<VariantEntity>();
        //            model.Initialize(child);
        //            variantEntityList.Add(model);
        //        }
        //    }
        //    var model1 = ModelProvider.GetModel<ProductEntity>();
        //    model1.Initialize(productItem, variantEntityList);
        //    var model2 = ModelProvider.GetModel<CatalogItemRenderingModel>();
        //    Init(model2);
        //    if (SiteContext.UrlContainsCategory)
        //    {
        //        model2.ParentCategoryId = CatalogUrlManager.ExtractCategoryNameFromCurrentUrl();
        //        var category = SearchManager.GetCategory(model2.ParentCategoryId, currentStorefront.Catalog);
        //        if (category != null)
        //            model2.ParentCategoryName = category.DisplayName;
        //    }
        //    if (model2.ProductId == currentStorefront.GiftCardProductId)
        //    {
        //        model2.GiftCardAmountOptions = GetGiftCardAmountOptions(visitorContext, currentStorefront, model1);
        //    }
        //    else
        //    {
        //        CatalogManager.GetProductPrice(currentStorefront, visitorContext, model1);
        //        model2.CustomerAverageRating = CatalogManager.GetProductRating(productItem);
        //    }
        //    model2.Initialize(model1);
        //    return model2;
        //}
    }
}